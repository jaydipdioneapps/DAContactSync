...
public func authorizationStatus() -> CNAuthorizationStatus {
    ...
    @available(macOS 12.0.0, iOS 15.0.0, *)
 public func fetchContacts(keysToFetch: [CNKeyDescriptor] = [CNContactVCardSerialization.descriptorForRequiredKeys()], order: CNContactSortOrder = .none, unifyResults: Bool = true) async throws -> [DAContactModel] {
...
/// - Throws: Error information, if an error occurred.
/// - Returns: Array  of contacts
public func fetchSingleContact(withIdentifiers identifier: String, keysToFetch: [CNKeyDescriptor] = [CNContactVCardSerialization.descriptorForRequiredKeys()]) throws -> DAContactModel? {
